        ...
        txtSname.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!(Character.isLetter(c) ||
                    ...
                    getToolkit().beep();
                    JOptionPane.showMessageDialog(null, "This Field Only accept text", "Error",JOptionPane.DEFAULT_OPTION);
                    e.consume();
                }
            }
        });
        txtDesignation.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!(Character.isLetter(c) ||
                    ...
                    getToolkit().beep();
                    JOptionPane.showMessageDialog(null, "This Field Only accept text", "Error",
        ...
        Update.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (txtDesignation.getText() == null ||txtDesignation.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter Employee job","Error", JOptionPane.DEFAULT_OPTION);
                ...
                try {
                    Statement statement = DBConnection.getDBConnection().createStatement();
                    {
                        ...
                        String temp = "UPDATE employee SET " +
                                "  first_name      ='" + txtSname.getText() +
                                "',last_name      ='" + txtFname.getText() +
                                "',gender     ='" + cbogender.getSelectedItem() +
                                "',birth        ='" + dobs.getText() +
                                "',job='" + txtDesignation.getText() +
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    if (!txtEmpNo.equals("")) {
                        ...
                        Statement statement = DBConnection.getDBConnection().createStatement();
                        String query = ("SELECT * FROM employee where empno ='" + txtEmpNo.getText() + "'");
