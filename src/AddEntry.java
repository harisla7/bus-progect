...
public class AddEntry extends JInternalFrame {
        ...
        btnAddNew.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String sql = "INSERT INTO buses (bus_no, busreqno, model, capacity, datebought,insurance_status,date_insurancediInsurance_expiry) VALUES ('" +
                            txtBusNo.getText() + "', '" +
                            txtRegNo.getText() + "', '" +
                            txtModel.getText() + "', '" +
                            txtCapacity.getText() + "', '" +
    ...
    private void generator() {
        try {
            Statement stmt = DBConnection.getDBConnection().createStatement();
            ResultSet rst = stmt.executeQuery("select * from buses where bus_no =(SELECT Max(buses.bus_no) AS MaxOfBusNo FROM buses)");
