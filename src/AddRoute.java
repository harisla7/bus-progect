        ...
        AddNew.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    {
                        String temp = "INSERT INTO routes (route_no, route_name, departure, arrival, distance,fare_charged) VALUES ('" +
                                txtRouteNo.getText() + "', '" +
    ...
    private void generator() {
        ...
        try {
            ResultSet rst = DBConnection.getDBConnection().createStatement(
                    ...
                    ResultSet.CONCUR_UPDATABLE).executeQuery("SELECT route_no FROM routes");
            while (rst.next()) {
                String s;
